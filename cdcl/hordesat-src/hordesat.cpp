...
// This is the source code for HordeSAT, a parallel portfolio for SAT solver algorithms
// With this source code, we performed an evaluation of the performance of the CDCL algorithm 
// using this parallel portfolio

// Paper: https://algo2.iti.kit.edu/balyo/papers/horde.pdf


#include "solvers/CDCL.h"
...
int main(int argc, char** argv) {
	...
	for (int i = 0; i < solversCount; i++) {
		solvers.push_back(new cdcl());
		log(1, "Running cdcl on core %d of node %d/%d\n", i, mpi_rank, mpi_size);
	}
	...
	// Global statistics
	// aggregating statistics across all MPI processes and storing combined result on the root process
